"""Regression checks for the phpauth casebook."""
...
from casebook.harness import assert_expected, phpauth_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(phpauth_summary(), assert_expected())
