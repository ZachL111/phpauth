...
phpauth is a PHP project for security tooling. It focuses on this technical goal: Validate OAuth callback state, nonce, issuer, audience, and redirect policy fixtures.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 178, risk penalty 5, latency penalty 4, and weight bonus 4. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
